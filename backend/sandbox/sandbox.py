...
async def get_or_start_sandbox(sandbox_id: str):
    ...
    try:
        ...
        # Manuals are now managed via Supabase; skip creation of /workspace/manuals/Product Manual Data
        # If you need to create other directories for non-manual files, do so here.
