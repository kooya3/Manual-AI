                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE MANUAL AGENT
                      AGENT WEBSITE AND ALL RELATED SERVICES.
                    </p>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        "Site" refers to the Manual Agent's website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Manual Agent's website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Manual Agent is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Manual Agent's logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE MANUAL AGENT'S WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      MANUAL AGENT'S DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Manual Agent in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Manual Agent does not collect biometric or identifying
